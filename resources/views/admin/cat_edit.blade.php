        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="#" class="nav-item nav-link active"><i class="fa fa-keyboard me-2"></i>Forms</a>
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Category Form Update</h6>
                            <form method="post" action="{{url('/update')}}">
                                @csrf
                                <div class="row mb-3">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Category Name</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="add_cat" value="{{$data[0]['cat_name']}}" class="form-control" id="inputCategory">
                                        <input type="hidden" name="add_id" value="{{$data[0]['id']}}" class="form-control" id="inputCategory">
                                    </div>
                                </div>
